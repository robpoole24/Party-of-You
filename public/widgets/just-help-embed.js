...
(function () {
  ...
  // Service IDs MUST match Just Help's checkbox values exactly
  const SERVICES = [
    { id: 'food',              label: 'Food Pantries'        },
    { id: 'shelter',           label: 'Shelter'              },
    { id: 'domestic_violence', label: 'DV Safe Housing'      },
    { id: 'clothing',          label: 'Clothing'             },
    { id: 'rent',              label: 'Rent Assistance'      },  // Just Help uses 'rent'
    { id: 'utilities',         label: 'Utility Assistance'   },  // Just Help uses 'utilities'
    { id: 'healthcare',        label: 'Free Clinics'         },
    { id: 'dental',            label: 'Free/Low-Cost Dental' },
    { id: 'holiday_meals',     label: 'Holiday Meals'        },
    { id: 'holiday_toys',      label: 'Holiday Gifts (Kids)' },  // Just Help uses 'holiday_toys'
